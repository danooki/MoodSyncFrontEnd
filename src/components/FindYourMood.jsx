        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                ...
                You'll be able to answer daily questions and discover your DISC personality traits.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Dominance</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Steadiness</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="mt-6">
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Conscientiousness</h3>
              <p className="text-gray-600 text-sm">

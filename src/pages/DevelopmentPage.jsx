          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-600 mb-4">
                ...
                help friends and partners better understand each other and plan
                activities that everyone will enjoy.
              </p>

              {/* links to jobs and github */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                {/* LinkedIn Button */}
                <a
                  href="https://www.linkedin.com/in/danielfuentealba"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                ...
                design, real-time updates, and intuitive user interface for mood
                tracking and circle management.
              </p>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                ...
                authentication. Handles user management, circle operations, and
                mood assessment processing.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
